            ...
            <section class="bg-white dark:bg-[#111] p-6 rounded-2xl border border-gray-100 dark:border-white/10 shadow-sm">
                ...
                <div class="mt-4 p-4 bg-gray-50 dark:bg-[#1a1a1a] rounded-xl text-xs font-mono text-gray-800 dark:text-gray-200 space-y-2">
                    ...
                    <div class="border-t border-gray-200 dark:border-white/10 pt-2 mt-2 space-y-1">
                        ...
                        <p><strong>Legal Counsel Email:</strong> <a href="mailto:legal@ridemycars.com" class="text-amber-700 dark:text-amber-400 font-bold hover:underline">legal@ridemycars.com</a></p>
                    </div>
                </div>
            </section>
