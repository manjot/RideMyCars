...
<head>
    ...
    <link rel="canonical" href="https://www.ridemycars.com/signup">
...
<body class="font-sans antialiased bg-white dark:bg-[#111] text-gray-900 dark:text-white overflow-x-hidden">
        ...
        <div class="w-full lg:w-[55%] lg:ml-[45%] flex items-center justify-center p-8 lg:py-16 lg:px-24">
            <div class="w-full max-w-lg">
                ...
                <div class="space-y-3 mb-6">
                    <button type="button" id="google-signup-btn" @click="triggerGoogleAuth(currentRole)" class="w-full flex items-center justify-center gap-3 py-3.5 bg-gray-100 hover:bg-gray-200 dark:bg-white/5 dark:hover:bg-white/10 text-gray-900 dark:text-white font-semibold rounded-xl border border-gray-200/50 dark:border-white/5 transition-all duration-200 shadow-sm hover:shadow active:scale-[0.99] text-decoration-none cursor-pointer">
    ...
    <script>
        ...
        function triggerGoogleAuth(role = 'customer') {
            ...
            const btnText = document.getElementById('google-signup-btn-text');
            const origText = btnText ? btnText.innerText : 'Sign up with Google';
