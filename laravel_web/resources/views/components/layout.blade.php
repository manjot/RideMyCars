            ...
            <div class="flex h-20 items-center justify-between">
                ...
                <div class="flex items-center gap-3 lg:gap-6 shrink-0">
                    ...
                    <div x-data="{ userMenuOpen: false }" class="relative" @click.away="userMenuOpen = false">
                        ...
                        <div x-show="userMenuOpen" x-transition class="absolute top-full right-0 mt-4 w-[340px] bg-white dark:bg-[#111] border border-gray-100 dark:border-white/10 shadow-2xl rounded-2xl p-5 z-50" style="display: none;">
                            
                            <!-- Header -->
                            <div class="flex items-start justify-between mb-6">
                                <div>
                                    <h2 class="text-2xl font-bold text-black dark:text-white uppercase leading-tight">{{ auth()->user()->name }}</h2>
                                    <div class="inline-flex items-center gap-1 bg-gray-100 dark:bg-gray-800 px-2 py-0.5 rounded-full mt-1">
                                ...
                                <div class="w-16 h-16 rounded-full bg-gray-200 text-gray-700 flex items-center justify-center font-bold text-2xl border border-gray-300 shrink-0 overflow-hidden shadow-sm">
                                    {{ substr(auth()->user()->name, 0, 1) }}
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-3 gap-2 mb-4">
                                <a href="/help" class="flex flex-col items-center justify-center gap-2 p-3 bg-white dark:bg-[#222] border-[1.5px] border-brand-500 rounded-xl hover:bg-brand-50 transition-colors shadow-sm">
                                    ...
                                    <span class="text-sm font-bold text-black dark:text-white">Help</span>
                                </a>
                                <a href="/wallet" class="flex flex-col items-center justify-center gap-2 p-3 bg-gray-100 dark:bg-[#222] rounded-xl hover:bg-gray-200 transition-colors">
                                    ...
                                    <span class="text-sm font-bold text-black dark:text-white">Wallet</span>
                                </a>
                                <a href="/activity" class="flex flex-col items-center justify-center gap-2 p-3 bg-gray-100 dark:bg-[#222] rounded-xl hover:bg-gray-200 transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none" class="text-black dark:text-white"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z"/></svg>
                                    <span class="text-sm font-bold text-black dark:text-white">Activity</span>
                                </a>
                            </div>

                            <!-- Uber Cash -->
                            <a href="/wallet" class="flex items-center justify-between p-4 bg-gray-100 dark:bg-[#222] rounded-xl mb-4 hover:bg-gray-200 transition-colors">
                                <span class="font-bold text-black dark:text-white text-base">Uber Cash</span>
                                <span class="font-bold text-black dark:text-white text-xl">₹0.00</span>
                            </a>

                            <!-- List Links -->
                            <div class="space-y-1 mb-4">
                                <a href="/account" class="flex items-center gap-4 p-3 hover:bg-gray-50 dark:hover:bg-[#222] rounded-xl transition-colors">
                                    ...
                                    <span class="font-bold text-black dark:text-white text-[15px]">Manage account</span>
                                </a>
                                <div class="h-px bg-gray-100 dark:bg-white/5 mx-3 my-1"></div>
                                <a href="/promotions" class="flex items-center gap-4 p-3 hover:bg-gray-50 dark:hover:bg-[#222] rounded-xl transition-colors">
                                    ...
                                    <span class="font-bold text-black dark:text-white text-[15px]">Promotions</span>
                                </a>
                                <div class="h-px bg-gray-100 dark:bg-white/5 mx-3 my-1"></div>
                                <a href="/legal" class="flex items-center gap-4 p-3 hover:bg-gray-50 dark:hover:bg-[#222] rounded-xl transition-colors">
                                    ...
                                    <span class="font-bold text-black dark:text-white text-[15px]">Legal</span>
                                </a>
                            </div>
                            ...
                            <form method="POST" action="/logout">
                                @csrf
                                <button type="submit" class="w-full p-4 bg-gray-100 hover:bg-gray-200 dark:bg-[#222] dark:hover:bg-[#333] rounded-xl transition-colors text-center font-bold text-red-600 text-[15px]">
                                    Sign out
                                </button>
                            </form>
                        </div>
