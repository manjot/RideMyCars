<x-layout>
    ...
    <main class="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="text-center max-w-md mx-auto">
            <a href="/hire-driver/book/{{ $driverProfile->id }}?country={{ $currentCountryCode ?? ($driverProfile->country ?? 'USA') }}" class="w-full flex items-center justify-center gap-2 py-4 px-6 bg-brand-500 hover:bg-brand-600 text-white rounded-xl font-bold text-lg transition-all shadow-md shadow-brand-500/25">
