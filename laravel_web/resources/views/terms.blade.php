<x-layout>
    <x-slot:title>Terms of Service — RideMyCars</x-slot>

    <main class="flex-1 w-full max-w-3xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
            <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-2">Terms of Service</h1>
            ...
            <div class="prose prose-gray max-w-none text-gray-600 dark:text-gray-400 space-y-8">
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-3">2. Services Provided</h2>
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-3">3. User Accounts</h2>
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-3">4. Booking and Cancellation</h2>
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-3">5. Payments and Fees</h2>
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-3">6. Prohibited Conduct</h2>
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-3">7. Limitation of Liability</h2>
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-3">8. Changes to Terms</h2>
