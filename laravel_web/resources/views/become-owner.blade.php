<x-layout>
    ...
    <section class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-32">
        <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-10 text-center">Your vehicle is protected</h2>
        ...
        <div class="space-y-4">
            <div class="bg-white dark:bg-[#111] rounded-2xl p-5 border border-gray-100 dark:border-white/10 shadow-sm flex items-center gap-4">
                ...
                <p class="text-gray-700 dark:text-gray-300 text-sm">All renters are identity-verified before booking</p>
            </div>
            <div class="bg-white dark:bg-[#111] rounded-2xl p-5 border border-gray-100 dark:border-white/10 shadow-sm flex items-center gap-4">
                <div class="w-6 h-6 rounded-full bg-green-50 text-green-500 flex items-center justify-center shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>
                </div>
                <p class="text-gray-700 dark:text-gray-300 text-sm">Insurance coverage up to $1M during every rental</p>
            </div>
            <div class="bg-white dark:bg-[#111] rounded-2xl p-5 border border-gray-100 dark:border-white/10 shadow-sm flex items-center gap-4">
                <div class="w-6 h-6 rounded-full bg-green-50 text-green-500 flex items-center justify-center shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>
                </div>
                <p class="text-gray-700 dark:text-gray-300 text-sm">You approve or decline any booking request</p>
            </div>
            <div class="bg-white dark:bg-[#111] rounded-2xl p-5 border border-gray-100 dark:border-white/10 shadow-sm flex items-center gap-4">
                <div class="w-6 h-6 rounded-full bg-green-50 text-green-500 flex items-center justify-center shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>
                </div>
                <p class="text-gray-700 dark:text-gray-300 text-sm">Damage deposit collected upfront from renters</p>
            </div>
            <div class="bg-white dark:bg-[#111] rounded-2xl p-5 border border-gray-100 dark:border-white/10 shadow-sm flex items-center gap-4">
                <div class="w-6 h-6 rounded-full bg-green-50 text-green-500 flex items-center justify-center shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>
                </div>
                <p class="text-gray-700 dark:text-gray-300 text-sm">In-app damage reporting with photo evidence</p>
            </div>
            <div class="bg-white dark:bg-[#111] rounded-2xl p-5 border border-gray-100 dark:border-white/10 shadow-sm flex items-center gap-4">
                <div class="w-6 h-6 rounded-full bg-green-50 text-green-500 flex items-center justify-center shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>
                </div>
                <p class="text-gray-700 dark:text-gray-300 text-sm">24/7 owner support hotline</p>
            </div>
        </div>
    </section>
</x-layout>
