<x-layout>
    <x-slot:title>Become an Owner — RideMyCars</x-slot>
    ...
    <div class="max-w-4xl mx-auto text-center px-4 pt-24 pb-20">
        ...
        <h1 class="text-5xl md:text-7xl font-extrabold text-gray-900 mb-6 tracking-tight">Your car earns while it parks.</h1>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-32">
        <h2 class="text-3xl font-bold text-gray-900 mb-10 text-center">Estimated monthly earnings</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white rounded-3xl p-10 border border-gray-100 shadow-sm text-center">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2">Economy</h3>
                <div class="text-3xl font-bold text-orange-500 mb-2">$450 – $900</div>
                <p class="text-sm text-gray-400">10–15 days/mo rented</p>
            </div>
            <div class="bg-white rounded-3xl p-10 border border-gray-100 shadow-sm text-center">
                <div class="w-12 h-12 rounded-full bg-orange-50 text-orange-500 flex items-center justify-center mx-auto mb-6">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>
                </div>
                <h3 class="text-lg font-bold text-gray-900 mb-2">Midsize / SUV</h3>
            ...
            <div class="bg-white rounded-3xl p-10 border border-gray-100 shadow-sm text-center">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2">Luxury</h3>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-32">
        <h2 class="text-3xl font-bold text-gray-900 mb-10 text-center">How it works</h2>
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-3">Create Listing</h3>
            ...
            <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-3">Renters Book</h3>
                <p class="text-sm text-gray-500 leading-relaxed">
            ...
            <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-3">Earn & Review</h3>
                <p class="text-sm text-gray-500 leading-relaxed">
    ...
    <section class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-32">
        <h2 class="text-3xl font-bold text-gray-900 mb-10 text-center">Your vehicle is protected</h2>
        
        <div class="space-y-4">
            <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex items-center gap-4">
                <div class="w-6 h-6 rounded-full bg-green-50 text-green-500 flex items-center justify-center shrink-0">
                ...
                <p class="text-gray-700 text-sm">All renters are identity-verified before booking</p>
            </div>
            <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex items-center gap-4">
                <div class="w-6 h-6 rounded-full bg-green-50 text-green-500 flex items-center justify-center shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>
                </div>
                <p class="text-gray-700 text-sm">Insurance coverage up to $1M during every rental</p>
            </div>
            <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex items-center gap-4">
                <div class="w-6 h-6 rounded-full bg-green-50 text-green-500 flex items-center justify-center shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>
                </div>
                <p class="text-gray-700 text-sm">You approve or decline any booking request</p>
            </div>
            <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex items-center gap-4">
                <div class="w-6 h-6 rounded-full bg-green-50 text-green-500 flex items-center justify-center shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>
                </div>
                <p class="text-gray-700 text-sm">Damage deposit collected upfront from renters</p>
            </div>
            <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex items-center gap-4">
                <div class="w-6 h-6 rounded-full bg-green-50 text-green-500 flex items-center justify-center shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>
                </div>
                <p class="text-gray-700 text-sm">In-app damage reporting with photo evidence</p>
            </div>
            <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex items-center gap-4">
                <div class="w-6 h-6 rounded-full bg-green-50 text-green-500 flex items-center justify-center shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg>
                </div>
                <p class="text-gray-700 text-sm">24/7 owner support hotline</p>
            </div>
        </div>
    </section>
</x-layout>
