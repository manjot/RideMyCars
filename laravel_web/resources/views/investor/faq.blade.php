    ...
    <div class="min-h-screen bg-slate-50/60 dark:bg-[#0b0f17] text-gray-900 dark:text-white relative overflow-hidden transition-colors selection:bg-brand-500 selection:text-black">
        ...
        <div class="max-w-5xl 2xl:max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 pb-20 relative z-10">
            ...
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <h1 class="text-3xl sm:text-5xl font-black text-gray-900 dark:text-white tracking-tight">Frequently Asked Questions</h1>
            ...
            <div class="space-y-4" x-data="{ active: 1 }">
                <!-- Q1 -->
                <div class="rounded-2xl bg-white dark:bg-[#151b26] border border-slate-200/90 dark:border-white/10 shadow-xs overflow-hidden transition-all">
                    <button @click="active = (active === 1 ? null : 1)" class="w-full p-6 text-left flex items-center justify-between gap-4 font-bold text-base sm:text-lg text-gray-900 dark:text-white hover:text-amber-600 dark:hover:text-amber-400 transition-colors">
                    ...
                    <div x-show="active === 1" x-collapse class="px-6 pb-6 text-xs sm:text-sm text-gray-600 dark:text-zinc-300 leading-relaxed space-y-2 border-t border-slate-100 dark:border-white/[0.04] pt-4">
                ...
                <!-- Q2 -->
                <div class="rounded-2xl bg-white dark:bg-[#151b26] border border-slate-200/90 dark:border-white/10 shadow-xs overflow-hidden transition-all">
                    <button @click="active = (active === 2 ? null : 2)" class="w-full p-6 text-left flex items-center justify-between gap-4 font-bold text-base sm:text-lg text-gray-900 dark:text-white hover:text-amber-600 dark:hover:text-amber-400 transition-colors">
                    ...
                    <div x-show="active === 2" x-collapse class="px-6 pb-6 text-xs sm:text-sm text-gray-600 dark:text-zinc-300 leading-relaxed space-y-2 border-t border-slate-100 dark:border-white/[0.04] pt-4">
                ...
                <!-- Q3 -->
                <div class="rounded-2xl bg-white dark:bg-[#151b26] border border-slate-200/90 dark:border-white/10 shadow-xs overflow-hidden transition-all">
                    <button @click="active = (active === 3 ? null : 3)" class="w-full p-6 text-left flex items-center justify-between gap-4 font-bold text-base sm:text-lg text-gray-900 dark:text-white hover:text-amber-600 dark:hover:text-amber-400 transition-colors">
                    ...
                    <div x-show="active === 3" x-collapse class="px-6 pb-6 text-xs sm:text-sm text-gray-600 dark:text-zinc-300 leading-relaxed space-y-2 border-t border-slate-100 dark:border-white/[0.04] pt-4">
                ...
                <!-- Q4 -->
                <div class="rounded-2xl bg-white dark:bg-[#151b26] border border-slate-200/90 dark:border-white/10 shadow-xs overflow-hidden transition-all">
                    <button @click="active = (active === 4 ? null : 4)" class="w-full p-6 text-left flex items-center justify-between gap-4 font-bold text-base sm:text-lg text-gray-900 dark:text-white hover:text-amber-600 dark:hover:text-amber-400 transition-colors">
                    ...
                    <div x-show="active === 4" x-collapse class="px-6 pb-6 text-xs sm:text-sm text-gray-600 dark:text-zinc-300 leading-relaxed space-y-2 border-t border-slate-100 dark:border-white/[0.04] pt-4">
                ...
                <!-- Q5 -->
                <div class="rounded-2xl bg-white dark:bg-[#151b26] border border-slate-200/90 dark:border-white/10 shadow-xs overflow-hidden transition-all">
                    <button @click="active = (active === 5 ? null : 5)" class="w-full p-6 text-left flex items-center justify-between gap-4 font-bold text-base sm:text-lg text-gray-900 dark:text-white hover:text-amber-600 dark:hover:text-amber-400 transition-colors">
                    ...
                    <div x-show="active === 5" x-collapse class="px-6 pb-6 text-xs sm:text-sm text-gray-600 dark:text-zinc-300 leading-relaxed space-y-2 border-t border-slate-100 dark:border-white/[0.04] pt-4">
                ...
                <!-- Q6 -->
                <div class="rounded-2xl bg-white dark:bg-[#151b26] border border-slate-200/90 dark:border-white/10 shadow-xs overflow-hidden transition-all">
                    <button @click="active = (active === 6 ? null : 6)" class="w-full p-6 text-left flex items-center justify-between gap-4 font-bold text-base sm:text-lg text-gray-900 dark:text-white hover:text-amber-600 dark:hover:text-amber-400 transition-colors">
                    ...
                    <div x-show="active === 6" x-collapse class="px-6 pb-6 text-xs sm:text-sm text-gray-600 dark:text-zinc-300 leading-relaxed space-y-2 border-t border-slate-100 dark:border-white/[0.04] pt-4">
            ...
            <div class="mt-16 p-8 rounded-3xl bg-white dark:bg-[#151b26] border border-slate-200/90 dark:border-white/10 shadow-sm text-center max-w-xl mx-auto">
                <div class="text-3xl mb-3">💬</div>
                <h3 class="text-lg font-black text-gray-900 dark:text-white">Have Specific Legal or Financial Inquiries?</h3>
                <p class="text-xs text-gray-600 dark:text-zinc-400 mt-1 mb-5 font-medium">Our Investor Relations Desk in Bethesda & Accra is standing by.</p>
