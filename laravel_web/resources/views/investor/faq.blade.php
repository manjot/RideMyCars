    ...
    <div class="min-h-screen bg-[#070a0f] text-slate-100 relative overflow-hidden">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20">
            ...
            <div class="text-center max-w-3xl mx-auto mb-16">
                <span class="text-xs font-black uppercase tracking-widest text-brand-400">Questions & Clarifications</span>
                <h1 class="text-3xl sm:text-5xl font-black text-white mt-2">Frequently Asked Questions</h1>
            ...
            <div class="space-y-4" x-data="{ active: 1 }">
                <!-- Q1 -->
                <div class="rounded-2xl bg-white/[0.02] border border-white/[0.08] overflow-hidden transition-all">
                    <button @click="active = (active === 1 ? null : 1)" class="w-full p-6 text-left flex items-center justify-between gap-4 font-bold text-base sm:text-lg text-white">
                        <span>Why does Ride My Cars gate its investment opportunity behind dynamic accreditation?</span>
                        <span class="text-brand-500 text-xl" x-text="active === 1 ? '−' : '+'"></span>
                    </button>
                    <div x-show="active === 1" x-collapse class="px-6 pb-6 text-xs sm:text-sm text-zinc-300 leading-relaxed space-y-2 border-t border-white/[0.04] pt-4">
                ...
                <!-- Q2 -->
                <div class="rounded-2xl bg-white/[0.02] border border-white/[0.08] overflow-hidden transition-all">
                    <button @click="active = (active === 2 ? null : 2)" class="w-full p-6 text-left flex items-center justify-between gap-4 font-bold text-base sm:text-lg text-white">
                        <span>What is the role of Eminsang Group Limited in this transaction?</span>
                        <span class="text-brand-500 text-xl" x-text="active === 2 ? '−' : '+'"></span>
                    </button>
                    <div x-show="active === 2" x-collapse class="px-6 pb-6 text-xs sm:text-sm text-zinc-300 leading-relaxed space-y-2 border-t border-white/[0.04] pt-4">
                ...
                <!-- Q3 -->
                <div class="rounded-2xl bg-white/[0.02] border border-white/[0.08] overflow-hidden transition-all">
                    <button @click="active = (active === 3 ? null : 3)" class="w-full p-6 text-left flex items-center justify-between gap-4 font-bold text-base sm:text-lg text-white">
                        <span>How are dividend distributions calculated and paid?</span>
                        <span class="text-brand-500 text-xl" x-text="active === 3 ? '−' : '+'"></span>
                    </button>
                    <div x-show="active === 3" x-collapse class="px-6 pb-6 text-xs sm:text-sm text-zinc-300 leading-relaxed space-y-2 border-t border-white/[0.04] pt-4">
                ...
                <!-- Q4 -->
                <div class="rounded-2xl bg-white/[0.02] border border-white/[0.08] overflow-hidden transition-all">
                    <button @click="active = (active === 4 ? null : 4)" class="w-full p-6 text-left flex items-center justify-between gap-4 font-bold text-base sm:text-lg text-white">
                        <span>What happens at the end of the 3-Year Single Cohort term?</span>
                        <span class="text-brand-500 text-xl" x-text="active === 4 ? '−' : '+'"></span>
                    </button>
                    <div x-show="active === 4" x-collapse class="px-6 pb-6 text-xs sm:text-sm text-zinc-300 leading-relaxed space-y-2 border-t border-white/[0.04] pt-4">
                ...
                <!-- Q5 -->
                <div class="rounded-2xl bg-white/[0.02] border border-white/[0.08] overflow-hidden transition-all">
                    <button @click="active = (active === 5 ? null : 5)" class="w-full p-6 text-left flex items-center justify-between gap-4 font-bold text-base sm:text-lg text-white">
                        <span>How is my personal data and financial information protected?</span>
                        <span class="text-brand-500 text-xl" x-text="active === 5 ? '−' : '+'"></span>
                    </button>
                    <div x-show="active === 5" x-collapse class="px-6 pb-6 text-xs sm:text-sm text-zinc-300 leading-relaxed space-y-2 border-t border-white/[0.04] pt-4">
                ...
                <!-- Q6 -->
                <div class="rounded-2xl bg-white/[0.02] border border-white/[0.08] overflow-hidden transition-all">
                    <button @click="active = (active === 6 ? null : 6)" class="w-full p-6 text-left flex items-center justify-between gap-4 font-bold text-base sm:text-lg text-white">
                        <span>Why can I not view wire instructions or payment coordinates before approval?</span>
                        <span class="text-brand-500 text-xl" x-text="active === 6 ? '−' : '+'"></span>
                    </button>
                    <div x-show="active === 6" x-collapse class="px-6 pb-6 text-xs sm:text-sm text-zinc-300 leading-relaxed space-y-2 border-t border-white/[0.04] pt-4">
            ...
            <div class="mt-16 p-8 rounded-3xl bg-white/[0.02] border border-white/[0.08] text-center max-w-xl mx-auto">
                <div class="text-2xl mb-2">💬</div>
                <h3 class="text-lg font-black text-white">Have Specific Legal or Financial Inquiries?</h3>
                <p class="text-xs text-zinc-400 mt-1 mb-5">Our Investor Relations Desk in Bethesda & Accra is standing by.</p>
                <a href="/investor/contact" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-brand-500 hover:bg-brand-400 text-black font-black text-xs uppercase tracking-wider transition-all">
