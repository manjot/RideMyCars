  ...
  Future<void> _handleSendPhoneOtp() async {
    ...
    if (phone.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please enter your mobile phone number with country code'),
    ...
    if (res['not_found'] == true || res['user_exists'] == false) {
      // Unregistered phone -> initiate driver registration
      showDialog(
        context: context,
        builder: (ctx) => AlertDialog(
          backgroundColor: AppColors.surfaceDark,
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
          title: const Text('Driver Not Registered', style: TextStyle(color: AppColors.textLight, fontWeight: FontWeight.bold)),
          content: Text(
            'No driver account was found for $phone. Would you like to register as a driver now?',
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_isPhoneAuth) ...[
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: 'Driver Mobile Phone (e.g. +1 555-123-4567)',
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                const Text('Enter 4-Digit Code', style: TextStyle(color: AppColors.textLight, fontWeight: FontWeight.bold, fontSize: 14)),
                                Text(
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: auth.isLoading
                              ...
                              : const Text('Verify & Open Dashboard', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w900)),
                        ),
                      ),
                    ],
                  ] else ...[
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: auth.isLoading
                            ...
                            : const Text('Sign In to Dashboard', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w900)),
                      ),
                    ),
                  ],
                  ...
                  Row(
                    ...
                    children: [
                      const Text("New driver? ", style: TextStyle(color: AppColors.textMuted)),
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
