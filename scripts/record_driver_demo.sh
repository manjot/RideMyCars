#!/bin/bash
# ─────────────────────────────────────────────────────────────────────────────
#  RideMyCars – Driver App Screen Recording Script for Apple App Store Review
#  Records full user walkthrough: Login → Dashboard → Drawer → Account → Logout
# ─────────────────────────────────────────────────────────────────────────────
set -e

SIM_UDID="60D7F70F-8B73-426B-86B7-8D8CA6F945D8"
BUNDLE_ID="com.ridemycars.driver"
OUTPUT_DIR="/Users/manjotsingh/RideMyCars/store_metadata/driver_assets"
OUTPUT_FILE="$OUTPUT_DIR/RideMyCars_Driver_Demo.mp4"
FLUTTER_PROJECT="/Users/manjotsingh/RideMyCars/flutter_driver_app"

echo "======================================================"
echo "  RideMyCars Driver App – Apple Review Screen Recording"
echo "======================================================"
...
echo "[6/7] Running Driver walkthrough integration test..."
cd "$FLUTTER_PROJECT"
flutter test integration_test/driver_walkthrough_test.dart \
  -d "$SIM_UDID" \
  --reporter expanded
